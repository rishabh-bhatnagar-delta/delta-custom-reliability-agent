...
def get_dynamodb_resilience_report(dimensions: List[Dict[str, Any]]) -> ResourceResilienceOutput:
    ...
    if not a.dim("DeletionProtection"):
        a.add_gap("Deletion Protection", "DISABLED",
                   ...
                   recommendation="Enable deletion protection to prevent accidental table removal.",
    ...
    if pitr_status != "ENABLED":
        a.add_gap("Point-in-Time Recovery", "DISABLED",
                   ...
                   recommendation="Enable PITR for continuous backup and granular recovery.",
    ...
    if not a.dim("GlobalTableRegions", []):
        a.add_gap("Multi-Region (Global Tables)", "NOT CONFIGURED",
                   ...
                   recommendation="Configure Global Tables for multi-region redundancy and lower read latency.",
    ...
    if not a.dim("AutoScaling", []):
        a.add_gap("Auto Scaling", "NOT CONFIGURED",
                   ...
                   recommendation="Enable auto scaling or switch to on-demand capacity mode.",
    ...
    if not stream_enabled:
        a.add_gap("DynamoDB Streams", "DISABLED",
                   ...
                   recommendation="Enable DynamoDB Streams for change data capture and event-driven processing.")
